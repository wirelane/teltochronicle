# RUT956 firmware changelog

## Overview

- Stable firmware: `RUT9M_R_00.07.24`
- Latest firmware: `RUT9M_R_00.07.24`

---

## RUT9M_R_00.07.24 | 2026.07.08
...
* 2FA: moved service to Package manager
...
* IEC 60870-5 Client: fixed an issue where a closed serial port would cause the application to crash
* IEC 60870-5 Client: fixed validation errors during backup upload
...
### Fix
#### Network
* BFD: fixed package re-installation after updating with keep settings
...
* VLAN: added support for tagged and untagged VLANs on one port
...
* MQTT Modbus Gateway: increased serial connection robustness
...
* DNP3 Outstation: fixed broken links to "DNP3 Serial Outstation" page
...
* Event juggler: added support to monitor relay pin state
...
* Modbus Client: added new option "Inter-device delay" to serial device configuration
...
* Event juggler: fixed relay value setting action
...
* Modbus TCP over Serial Gateway: added support for MODBUS broadcast messages
...
#### Services
* BACnet: fixed port, network_id, interface API validations
...
#### Services
* BACnet: fixed require of 'bbmd_port' option in API
...
* Mobile: added eSIM support for devices with eSIM
...
* Fixed RMS I/O data display to return values calculated by formula
#### WebUI
...
* Moved SOcat to Package Manager
#### WebUI
...
* Added formula for analog signal value conversion to other unit value
* Configurable GPS NMEA prefix
* Support for using hostnames in "Server address" field for NTRIP service
* "Start up message" field for Modem control serial utility
* Modem Debug page
...
* New "Server+Client" work mode for OverIP Serial Utility
* New "Connect on data" action for OverIP Serial Utility
* Multiple Client instance support for OverIP Serial Utility
...
* Changed modem init behavior if Modem Control serial utility feature is enabled
...
* Fixed RS485 console return symbol skip
...
* Fixed missing 10 pin I/O connector display
...
### New features
* Initial FW release for the RUT956 device
